...
@Threads(1)
@Fork(1)
public class BenchmarkCachedKeyMatchModel {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkCachedKeyMatchModel.class.getName())
                .exclude("Pref")
    ...
    @Benchmark
    public void benchmarkCachedKeyMatchModel(BenchmarkState state) {
