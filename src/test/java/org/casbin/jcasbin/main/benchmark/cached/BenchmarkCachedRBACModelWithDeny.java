...
@Threads(1)
@Fork(1)
public class BenchmarkCachedRBACModelWithDeny {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkCachedRBACModelWithDeny.class.getName())
                .exclude("Pref")
    ...
    @Benchmark
    public void benchmarkCachedRBACModelWithDeny(BenchmarkState state) {
